...
public class Bai1Activity extends AppCompatActivity {
    ...
    void findControls(){
        EditText editHeight = findViewById(R.id.bai1);
        EditText editWeight = findViewById(R.id.bai1);
        Button button = findViewById(R.id.button);
        TextView bmi = findViewById(R.id.bai1);
        TextView status = findViewById(R.id.bai1);
    }
}